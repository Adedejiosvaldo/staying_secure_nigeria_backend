...
CREATE INDEX IF NOT EXISTS idx_heartbeats_user_timestamp ON heartbeats(user_id, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_heartbeats_last_gasp ON heartbeats(user_id, last_gasp) WHERE last_gasp = TRUE;
